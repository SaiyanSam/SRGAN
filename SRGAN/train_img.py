...
def evaluate():
    ...
    valid_lr_img = cv2.imread('test.jpg')
    valid_lr_img = cv2.cvtColor(valid_lr_img, cv2.COLOR_BGR2RGB)
    ...
    tlx.vision.save_image(out, file_name='upscaled_gen.png', path=save_dir)
